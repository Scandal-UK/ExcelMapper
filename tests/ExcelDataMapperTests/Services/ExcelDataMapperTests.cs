// <copyright file="ExcelDataMapperTests.cs" company="Dan Ware">
...
public class ExcelDataMapperTests
{
    ...
    {
        // Arrange
        var excelDataReader = new ExcelDataMapper<FakeEntity>();
    ...
    /// <summary> Exposes a private method in the <see cref="ExcelDataMapper{T}"/> class for usage in local tests. </summary>
    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = nameof(ColumnIndexFromCellReference))]
    private static extern int ColumnIndexFromCellReference(ExcelDataMapper<FakeEntity> @this, string cellReference);
